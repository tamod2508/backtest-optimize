...
def run(exchange: str, symbol: str, strategy: str, tf: str, from_time: int, to_time: int):
    ...
    if strategy == "obv":
        ...
        pnl, max_drawdown = strategies.macd.backtest(data, macd_fast=params["macd_fast"], macd_slow=params["macd_slow"], macd_signal=params["macd_signal"], take_profit=params["take_profit"], stop_loss=params["stop_loss"])
